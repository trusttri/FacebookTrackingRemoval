...
const AD_BUTTON_STYLE = 'width: 127px; padding: 0.4px 2px 2.6px 0px; text-align: center; border-radius: 20px; text-decoration: none; display: inline-block; font-size: 0.89rem; cursor: pointer; color: var(--blue-link); border: 1px solid var(--blue-link); font-family: sans-serif;'
