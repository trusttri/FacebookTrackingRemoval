        ...
        if (header){
            ...
            if (adBtn){
                ...
                if(three_dot_svg && !three_dot_svg.classList.contains("dropdown")){
                    ...
                    const BTN_SETTINGS_ICON = '<img class="hu5pjgll" style="vertical-align: -5px; margin-left: 2px; margin-right: 2px;" height="20" src="https://static.xx.fbcdn.net/rsrc.php/v3/yn/r/wIxncaU7_F8.png" width="20" alt="">'
