...
const AD_BUTTON_STYLE = 'width: 120px; padding: 0.5px 1px 2.5px 0px; text-align: center; border-radius: 20px; text-decoration: none; display: inline-block; font-size: 0.89rem; cursor: pointer; color: var(--blue-link); border: 1px solid var(--blue-link); font-family: sans-serif;'
        ...
        if (header){
            ...
            if (adBtn){
                ...
                if(three_dot_svg && !three_dot_svg.classList.contains("dropdown")){
                    ...
                    settingsBtn.innerHTML = BTN_SETTINGS_ICON + "<span>ad settings</span>" + DROPDOWN_SVG
