...
const DROPDOWN_SVG = '<svg fill=white style="display: inline-block; vertical-align: middle; padding-right: 2px; margin-bottom: 4px; margin-left: 0.2rem;" viewBox="-1 -4.5 12 19" width="0.4em" height="0.4em" class="dropdown a8c37x1j ms05siws l3qrxjdp b7h9ocf4 py1f6qlh jnigpg78 odw8uiq3"><g fill-rule="evenodd" transform="translate(-448 -544)"><path fill-rule="nonzero" d="M452.707 549.293a1 1 0 0 0-1.414 1.414l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0-1.414-1.414L456 552.586l-3.293-3.293z"></path></g></svg>'
const AD_BUTTON_STYLE = 'width: 8rem; padding: 0.3rem 0.5rem 0.2rem 0.5rem; text-align: center; border-radius: 20px; text-decoration: none; display: inline-block; font-size: 0.89rem; cursor: pointer; color: white; background-color: rgb(24, 119, 242); border: 1px solid var(--blue-link); font-family: sans-serif;'
        ...
        if (header){
            ...
            if (adBtn){
                ...
                if(three_dot_svg && !three_dot_svg.classList.contains("dropdown")){
                    ...
                    const BTN_SETTINGS_ICON = '<img class="hu5pjgll" style="vertical-align: -5px; margin-left: 2px; margin-right: 0.3rem;" height="20" src="https://static.xx.fbcdn.net/rsrc.php/v3/yn/r/wIxncaU7_F8.png" width="20" alt="">'
