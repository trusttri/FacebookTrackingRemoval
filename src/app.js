...
const DROPDOWN_SVG = '<svg fill=white style="display: inline-block; vertical-align: middle; margin-bottom: 0.27rem;" viewBox="-1 -4.5 15.5 19.5" height="auto" class="dropdown a8c37x1j ms05siws l3qrxjdp b7h9ocf4 py1f6qlh jnigpg78"><g fill-rule="evenodd" transform="translate(-448 -544)"><path fill-rule="nonzero" d="M452.707 549.293a1 1 0 0 0-1.414 1.414l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0-1.414-1.414L456 552.586l-3.293-3.293z"></path></g></svg>'
...
const BTN_SETTINGS_ICON = '<img class="hu5pjgll" style="vertical-align: middle; margin-right: 0.17rem;;" height=auto src="https://static.xx.fbcdn.net/rsrc.php/v3/yn/r/wIxncaU7_F8.png" width="16%" alt="">'
