...
const DROPDOWN_SVG = '<svg fill=var(--secondary-button-text) style="display: inline-block; vertical-align: middle; margin-bottom: 0.27rem;" viewBox="-1 -4.5 12 19" width="0.4em" height="0.4em" class="dropdown a8c37x1j ms05siws l3qrxjdp b7h9ocf4 py1f6qlh jnigpg78 odw8uiq3"><g fill-rule="evenodd" transform="translate(-448 -544)"><path fill-rule="nonzero" d="M452.707 549.293a1 1 0 0 0-1.414 1.414l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0-1.414-1.414L456 552.586l-3.293-3.293z"></path></g></svg>'
const AD_BUTTON_STYLE = 'width: 8rem; padding: 0.1rem 0.1rem; text-align: center; border-radius: 20px; text-decoration: none; display: inline-block; font-size: 0.89rem; cursor: pointer; background-color: var(--secondary-button-background); color: var(--secondary-button-text); border: 1.8px solid var(--blue-link); font-family: sans-serif;'
