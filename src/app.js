...
const DROPDOWN_SVG = '<svg fill="white" viewBox="-1 -2.5 16 16" width="1em" height="1em" class="dropdown style="vertical-align: middle; margin-bottom: 0.27rem; display: inline-block;"><g fill-rule="evenodd" transform="translate(-448 -544)"><path fill-rule="nonzero" d="M452.707 549.293a1 1 0 0 0-1.414 1.414l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 0 0-1.414-1.414L456 552.586l-3.293-3.293z"></path></g></svg>'
const AD_BUTTON_STYLE = 'width: 8rem; padding: 0.2rem 0.07rem 0.2rem 0.07rem; text-align: center; border-radius: 20px; text-decoration: none; display: inline-block; font-size: 0.89rem; cursor: pointer; color: white; background-color: rgb(24, 119, 242); border: 0.5px solid var(--blue-link); font-family: sans-serif;'
...
const BTN_SETTINGS_ICON = '<img class="hu5pjgll" style="vertical-align: middle; margin-right: 0.13rem;" height="80%" width="14%" src="https://static.xx.fbcdn.net/rsrc.php/v3/yn/r/wIxncaU7_F8.png" alt="">'
