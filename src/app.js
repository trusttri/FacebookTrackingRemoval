...
const AD_BUTTON_STYLE = 'width: 100px; padding: 1px 4px 4px 0px; text-align: center; border-radius: 20px; text-decoration: none; display: inline-block; font-size: 0.89rem; cursor: pointer; color: rgb(40 125 242); border: 2px solid #98bff1; font-family: sans-serif;'
