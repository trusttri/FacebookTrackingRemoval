...
const BTN_SETTINGS_ICON = '<img class="hu5pjgll" style="vertical-align: middle; margin-right: 0.13rem;" height="80%" src="https://static.xx.fbcdn.net/rsrc.php/v3/yn/r/wIxncaU7_F8.png" width="16%" alt="">'
    ...
    function run(body) {
        ...
        document.onclick = (e) => {
            ...
            if (typeof(closest_element_with_name) !== "string"){
                ...
                console.log(closest_element_with_name.name)
            }
            ...
            if (typeof(closest_element_with_inner_text) !== "string"){
                ...
                console.log(closest_element_with_inner_text.innerText)
            }
            ...
            if (typeof(closest_element_with_arialabel) !== "string"){
                ...
                console.log(closest_element_with_arialabel.ariaLabel)
            }
